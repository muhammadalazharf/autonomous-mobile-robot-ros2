"""
Master launch — FULL SYSTEM: Layer 1-5 + Brain.

Gerbang: SEMUA layer sudah PASS satu per satu → baru boleh nyalakan ini.
JANGAN pakai ini sebelum setiap layer lolos uji individual.

Cara pakai:
  ros2 launch amr_startup full_system.launch.py database_path:=/home/azhar/maps/lab.db
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([db_arg, sensors, pose, localization, nav2, brain])
